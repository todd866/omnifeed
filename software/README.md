...
Implemented: [local private storage](runtime/README.md), with media imports and usage events.

Suggested layout for the remaining application: `collectors/`, `library/`, `api/`, `web/`, `ios/`. No framework scaffold yet: the native audio/BLE experiment and source audit should inform it.
